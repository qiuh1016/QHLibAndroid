package com.qiuhong.qhlibrary.widget;
...
public class QHLoadingView extends View {
    ...
    public QHLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.QHLoadingStyle);
    }

    public QHLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.QHLoadingView, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.QHLoadingView_qh_loading_view_size, DensityUtil.dip2px(context, 32));
        mPaintColor = array.getInt(R.styleable.QHLoadingView_android_color, Color.WHITE);
        array.recycle();
        initPaint();
    }

    public QHLoadingView(Context context, int size, int color) {
        super(context);
        mSize = size;
        mPaintColor = color;
        initPaint();
